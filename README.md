...
| 68 | **200-$-Push auf 15min, 1 Trade/Tag** (Regel des Nutzers) | **Brutto -2,53 bp, netto -11,55 bp** — der Markt gibt null her, die Reibung nimmt den Rest. Bei 0,387 BTC je Trade: **-26.412 $ im Suchzeitraum, davon 20.329 $ Gebuehren (77 %)**. Noetig waeren **58,1 %** Trefferquote (im Holdout **69,7 %**), gemessen **47,3 %** — und damit **unter** dem Zufallseinstieg (49,6 %). Damit die Gebuehr unter 10 % des Ziels bleibt, muesste das Ziel **~6.300 $** gross sein, nicht 200 $ | [`push200.md`](docs/push200.md) |
